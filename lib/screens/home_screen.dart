...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // Kept for backward compatibility with older code paths (unused currently).
  // This avoids linter warnings without removing the policy dialog implementation.
  // ignore: unused_element
  void _unusedFoodSafetyPolicyDialog(BuildContext context) => _showFoodSafetyPolicyDialog(context);
...
// Separate widget for use in MainTabScreen
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Wrap(
                spacing: 8,
                children: SellType.values.map((type) {
                  return FilterChip(
